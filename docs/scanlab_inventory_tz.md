...
Дата инвентаризации: 2026-02-16  
...
| Header: ссылки “Услуги, Процесс, Портфолио, Контакты” | PARTIAL | `3d_scan_workflow_&_portfolio_1/code.html`, `3d_scan_workflow_&_portfolio_2/code.html` | В части файлов есть “О нас” вместо “Процесс”. |
